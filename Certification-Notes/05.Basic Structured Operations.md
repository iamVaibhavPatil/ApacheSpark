...
Row objects internally represent arrays of bytes. They byte array interface is never shown to users because we only use column expressions to manipulate them.

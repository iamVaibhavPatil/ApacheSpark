...
A wide dependency style transformation will have input paritions contributing to many output partitions. It is also called as `Shuffle` whereby Spark will exchange partition across the cluster.
